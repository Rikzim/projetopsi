            ...
            <div class="profile-avatar-section">
                <div class="profile-avatar">
                    <?php if ($user->userProfile && $user->userProfile->imagem_perfil): ?>
                        <?= Html::img('http://localhost/projetopsi/maislusitania/backend/web/uploads/' . $user->userProfile->imagem_perfil, [
                ...
                <?= Html::a('Editar Perfil', ['update-profile'], ['class' => 'btn-edit-profile']) ?>
            </div>
